...
function Home() {
    ...
    // useEffect(() => {
    //     axios.get('https://jokeservice.onrender.com/api/jokes')
    //         .then((response) => {
        ...
        <div className="min-h-screen bg-repeat-x bg-[url('/public/HomeBg.webp')]">
            ...
            <div className="w-full text-center  ">
                ...
                <div className="bg-[url('/public/HomeBg.webp')] p-5">
                    ...
                    <Link to='/add-post'>
                        <button className='border border-colorOrange text-news duration-100 hover:bg-blue-200 cursor-pointer text-xs rounded-2xl p-2 bg-black'
            ...
            <div className='flex flex-wrap gap-2 pl-2 pb-2'>
                <Link to={"/post/" + "Javascript s Importance".split(" ").join("-")}>
                ...
                {/* {joke &&(<CardBox className='text-black' para={joke[0].content}>
                    JOKES 

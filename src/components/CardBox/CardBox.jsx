...
function CardBox({userName,para="This para is empty"}) {
  ...
  return (
     <div className="w-[300px] h-[250px] rounded-3xl shadow-md bg-colorOrange text-  overflow-hidden mt-5">
        {/* <img
        ...
        <div className="flex flex-col justify-between p-4 space-y-4 h-[220px]">
          ...
          <button
            type="button"
            className="text-sm cursor-pointer hover:bg-blue-300 flex items-center justify-center w-full p-2 font-medium tracking-wide rounded-md bg-gray-800 text-gray-200"
          >
            Read more
          </button>
        </div>
